...
description: "Aggregate and analyze product and business reviews from Google Maps, Amazon, Akta, and Xiaohongshu. Cross-platform review intelligence including rating patterns, common themes, competitive comparison, and customer satisfaction trends."
---

# Review Aggregator

Aggregate and analyze product and business reviews from Google Maps, Amazon, Akta, and Xiaohongshu. Cross-platform review intelligence including rating patterns, common themes, competitive comparison, and customer satisfaction trends. Read [the API map](references/sandbase-api-map.md) before selecting a capability.
