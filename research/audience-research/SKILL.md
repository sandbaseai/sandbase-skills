...
description: "Research target audiences across Reddit, Twitter, Instagram, and Xiaohongshu to understand demographics, interests, pain points, language patterns, and content preferences. Produces audience personas backed by real community data."
---

# Audience Research

Research target audiences across Reddit, Twitter, Instagram, and Xiaohongshu to understand demographics, interests, pain points, language patterns, and content preferences. Produces audience personas backed by real community data. Read [the API map](references/sandbase-api-map.md) before selecting a capability.
