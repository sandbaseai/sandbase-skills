---
name: wechat-search
description: "Search articles, videos, and content within the WeChat ecosystem. Covers cross-content-type search including Official Account articles, video channels, and mini-programs — the gateway to China's largest private-traffic platform."
---

# WeChat Search

Search articles, videos, and content within the WeChat ecosystem. Covers cross-content-type search including Official Account articles, video channels, and mini-programs — the gateway to China's largest private-traffic platform. Read [the API map](references/sandbase-api-map.md) before selecting a capability.
