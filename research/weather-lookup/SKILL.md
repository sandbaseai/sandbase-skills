---
name: weather-lookup
description: "Get current weather conditions and forecasts for any location worldwide. Returns temperature, humidity, wind, precipitation, UV index, and multi-day forecasts. Useful for travel planning, event scheduling, and logistics coordination."
---

# Weather Lookup

Get current weather conditions and forecasts for any location worldwide. Returns temperature, humidity, wind, precipitation, UV index, and multi-day forecasts. Useful for travel planning, event scheduling, and logistics coordination. Read [the API map](references/sandbase-api-map.md) before selecting a capability.
