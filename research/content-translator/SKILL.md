...
description: "Translate text content between languages with high quality and natural phrasing. Covers document translation, content localization, and multi-language research support for teams working across language barriers."
---

# Content Translator

Translate text content between languages with high quality and natural phrasing. Covers document translation, content localization, and multi-language research support for teams working across language barriers. Read [the API map](references/sandbase-api-map.md) before selecting a capability.
