# SandBase YouTube Transcript API Map
...
|---|---|
| `agentbody_youtube_transcript` | See `sandbase_describe_tool` for details. |
| `youtube_web_v2_video_captions` | See `sandbase_describe_tool` for details. |
| `youtube_web_v2_video_captions_result` | See `sandbase_describe_tool` for details. |
