...
description: "Research and collect social proof — testimonials, case studies, user reviews, social mentions, and community endorsements across platforms. Useful for marketing teams building trust content, landing pages, and sales collateral from authentic customer voices."
---

# Social Proof Research

Research and collect social proof — testimonials, case studies, user reviews, social mentions, and community endorsements across platforms. Useful for marketing teams building trust content, landing pages, and sales collateral from authentic customer voices. Read [the API map](references/sandbase-api-map.md) before selecting a capability.
