...
description: "Generate data-backed content briefs by analyzing Google SERP results, competitor content, keyword intent, and audience questions. Produces writer-ready briefs with target queries, required subtopics, recommended format, word count, and competitive differentiation angles."
---

# SEO Content Brief

Generate data-backed content briefs by analyzing Google SERP results, competitor content, keyword intent, and audience questions. Produces writer-ready briefs with target queries, required subtopics, recommended format, word count, and competitive differentiation angles. Read [the API map](references/sandbase-api-map.md) before selecting a capability.
...
- `dataforseo_v3_serp_google_related_searches_live_advanced`
