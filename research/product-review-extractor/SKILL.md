...
description: "Extract and analyze product reviews from e-commerce and review sites. Aggregates ratings, identifies common themes in positive and negative feedback, and surfaces actionable product insights from customer voices across platforms."
---

# Product Review Extractor

Extract and analyze product reviews from e-commerce and review sites. Aggregates ratings, identifies common themes in positive and negative feedback, and surfaces actionable product insights from customer voices across platforms. Read [the API map](references/sandbase-api-map.md) before selecting a capability.
