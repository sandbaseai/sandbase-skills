...
description: "Enrich any company with comprehensive firmographic data including industry, size, revenue, funding, tech stack, beneficial ownership, and regulatory status. Combines multiple data sources for complete B2B company intelligence and due diligence."
---

# Company Enrichment

Enrich any company with comprehensive firmographic data including industry, size, revenue, funding, tech stack, beneficial ownership, and regulatory status. Combines multiple data sources for complete B2B company intelligence and due diligence. Read [the API map](references/sandbase-api-map.md) before selecting a capability.
